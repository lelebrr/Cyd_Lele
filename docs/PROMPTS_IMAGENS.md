...
Use estes prompts no **Google AI Studio** (aistudio.google.com) com o modelo **Gemini 2.0 Flash Experimental** para gerar as imagens dos componentes.
...
1. **Use Gemini 2.0 Flash (Experimental)** - melhor para diagramas técnicos
