...
function enterCinemaMode() {
    ...
    CinemaMode.overlay.innerHTML = `
        <div class="cinema-content">
            <div class="cinema-dragon">ðŸ‰</div>
...
function loadIRBrand() {
    ...
    const brands = {
        ...
        led: ['Multilaser', 'Elgin', 'Positivo', 'GenÃ©rica'],
        fan: ['Arno', 'Mondial', 'BritÃ¢nia', 'Cadence', 'GenÃ©rica'],
...
function adjustACTemp(delta) {
    ...
    if (display) display.textContent = acTemp + 'Â°C';
