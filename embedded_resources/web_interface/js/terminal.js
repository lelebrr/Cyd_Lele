...
const COMMAND_CATEGORIES = {
    'WiFi Attacks': {
        ...
        auth_flood: { desc: 'Flood de autenticaÃ§Ã£o', handler: () => sendTerminalCommand('auth_flood') },
        ...
        wps_brute: { desc: 'ForÃ§a bruta WPS PIN', handler: () => sendTerminalCommand('wps_bruteforce') },
        hcxdump: { desc: 'Modo caÃ§ador HCX', handler: () => sendTerminalCommand('hcxdump') },
    ...
    'BLE Attacks': {
        ...
        ble_spam: { desc: 'BLE spam genÃ©rico [type]', handler: (a) => sendTerminalCommand('ble_spam', { type: a[0] || 'apple' }) },
        ...
        ble_tracker: { desc: 'CaÃ§ar AirTags/trackers', handler: () => sendTerminalCommand('ble_tracker') },
        ble_clone: { desc: 'Clonar dispositivo BLE', handler: () => sendTerminalCommand('ble_clone') },
        ble_flood: { desc: 'Flood de conexÃµes BLE', handler: () => sendTerminalCommand('ble_flood') },
    ...
    'Sistema': {
        ...
        reboot: { desc: 'Reiniciar dispositivo', handler: () => { terminalPrint('\x1b[33mâš ï¸ Reiniciando...\x1b[0m'); setTimeout(() => sendTerminalCommand('reboot'), 2000); } },
        uptime: { desc: 'Tempo ligado', handler: showUptime },
        heap: { desc: 'MemÃ³ria heap livre', handler: () => sendTerminalCommand('heap') },
        psram: { desc: 'Status PSRAM', handler: () => sendTerminalCommand('psram') },
        temp: { desc: 'Temperatura CPU', handler: () => sendTerminalCommand('temp') },
        battery: { desc: 'NÃ­vel da bateria', handler: () => sendTerminalCommand('battery') },
        version: { desc: 'VersÃ£o do firmware', handler: showVersion },
        mac: { desc: 'EndereÃ§os MAC', handler: () => sendTerminalCommand('mac') },
        ip: { desc: 'EndereÃ§o IP atual', handler: () => sendTerminalCommand('ip') },
        hostname: { desc: 'Nome do host', handler: () => terminalPrint('\x1b[32mHostname: Lele\x1b[0m') },
        factory_reset: { desc: 'Reset para fÃ¡brica', handler: () => { terminalPrint('\x1b[31mâš ï¸ USE COM CUIDADO!\x1b[0m'); sendTerminalCommand('factory_reset'); } },
        ...
        cpu_freq: { desc: 'FrequÃªncia da CPU', handler: () => sendTerminalCommand('cpu_freq') },
        sdk_version: { desc: 'VersÃ£o do SDK ESP', handler: () => sendTerminalCommand('sdk_version') }
    },
    'Arquivos': {
        ls: { desc: 'Listar arquivos [dir]', handler: (a) => sendTerminalCommand('ls', { path: a[0] || '/' }) },
        cd: { desc: 'Mudar diretÃ³rio [dir]', handler: (a) => sendTerminalCommand('cd', { path: a[0] }) },
        pwd: { desc: 'DiretÃ³rio atual', handler: () => sendTerminalCommand('pwd') },
        cat: { desc: 'Ver conteÃºdo [arquivo]', handler: (a) => sendTerminalCommand('cat', { file: a[0] }) },
        ...
        df: { desc: 'EspaÃ§o em disco', handler: () => sendTerminalCommand('df') },
        ...
        tail: { desc: 'Ãšltimas linhas [arquivo]', handler: (a) => sendTerminalCommand('tail', { file: a[0] }) }
    },
    'Rede': {
        ...
        netstat: { desc: 'ConexÃµes ativas', handler: () => sendTerminalCommand('netstat') },
        ifconfig: { desc: 'ConfiguraÃ§Ã£o de rede', handler: () => sendTerminalCommand('ifconfig') },
    ...
    'IR Control': {
        ir_send: { desc: 'Enviar cÃ³digo IR [nome]', handler: (a) => sendTerminalCommand('ir_send', { name: a.join(' ') }) },
        ir_learn: { desc: 'Aprender cÃ³digo IR', handler: () => sendTerminalCommand('ir_learn') },
        ir_list: { desc: 'Listar cÃ³digos salvos', handler: () => sendTerminalCommand('ir_list') },
        ir_delete: { desc: 'Deletar cÃ³digo [nome]', handler: (a) => sendTerminalCommand('ir_delete', { name: a[0] }) },
        ir_nuke: { desc: 'TV NUKE - todas as TVs', handler: () => { terminalPrint('\x1b[31mâ˜ ï¸ TV NUKE ATIVADO!\x1b[0m'); sendTerminalCommand('ir_nuke'); } },
    ...
    'CÃ¢meras': {
        cam_scan: { desc: 'Escanear cÃ¢meras IP', handler: () => sendTerminalCommand('cam_scan') },
        cam_attack: { desc: 'Atacar cÃ¢mera [ip]', handler: (a) => sendTerminalCommand('cam_attack', { ip: a[0] }) },
    ...
    'Som': {
        ...
        sounds: { desc: 'Listar sons disponÃ­veis', handler: () => sendTerminalCommand('sounds') },
        song: { desc: 'Tocar mÃºsica [nome]', handler: (a) => sendTerminalCommand('song', { name: a[0] }) }
    },
    'Fun & Easter Eggs': {
        matrix: { desc: 'Modo Matrix', handler: () => { if (typeof setTheme === 'function') setTheme('hacker'); terminalPrint('\x1b[32mWake up, Neo...\x1b[0m'); terminalPrint('\x1b[32mThe Matrix has you...\x1b[0m'); terminalPrint('\x1b[32mFollow the white rabbit. ðŸ‡\x1b[0m'); } },
        dragon: { desc: 'DragÃ£o fala [msg]', handler: (a) => { const msg = a.join(' ') || 'OlÃ¡!'; terminalPrint(`\x1b[35mðŸ² ${msg}\x1b[0m`); if (typeof dragonSay === 'function') dragonSay(msg); } },
        whoami: { desc: 'InformaÃ§Ãµes do sistema', handler: showWhoami },
        cowsay: { desc: 'Vaca diz [msg]', handler: (a) => showCowsay(a.join(' ') || 'Moo!') },
        fortune: { desc: 'Frase aleatÃ³ria', handler: showFortune },
        ...
        sl: { desc: 'Steam Locomotive', handler: () => terminalPrint('ðŸš‚ðŸ’¨ðŸ’¨ðŸ’¨ CHOO CHOO!') },
        rickroll: { desc: "Never gonna...", handler: () => terminalPrint('\x1b[35mðŸŽµ Never gonna give you up, never gonna let you down...\x1b[0m') },
        lele: { desc: 'Invocar Lele', handler: () => terminalPrint('\x1b[36mðŸ‘¦ Lele aparece!\x1b[0m') },
        lisa: { desc: 'Invocar Lisa', handler: () => terminalPrint('\x1b[35mðŸ‘§ Lisa aparece!\x1b[0m') },
        dance: { desc: 'DanÃ§ar', handler: () => terminalPrint('ðŸ’ƒðŸ•ºðŸ’ƒðŸ•ºðŸ’ƒ') },
        fire: { desc: 'Fogo!', handler: () => terminalPrint('ðŸ”¥ðŸ”¥ðŸ”¥ðŸ”¥ðŸ”¥ðŸ”¥ðŸ”¥ðŸ”¥ðŸ”¥ðŸ”¥') },
        explosion: { desc: 'ExplosÃ£o', handler: () => terminalPrint('ðŸ’¥ BOOM! ðŸ’¥') },
        pirate: { desc: 'Modo pirata', handler: () => terminalPrint('\x1b[33mðŸ´â€â˜ ï¸ Arr matey! Prepare the cannons!\x1b[0m') }
    },
    'Geral': {
        ...
        history: { desc: 'HistÃ³rico de comandos', handler: showHistory },
        alias: { desc: 'Ver aliases', handler: showAliases },
        export: { desc: 'Exportar variÃ¡vel', handler: () => terminalPrint('\x1b[33mUso: export VAR=value\x1b[0m') },
        env: { desc: 'VariÃ¡veis de ambiente', handler: showEnv },
        echo: { desc: 'Imprimir texto [msg]', handler: (a) => terminalPrint(a.join(' ')) },
        date: { desc: 'Data e hora atual', handler: () => terminalPrint(`\x1b[36mðŸ“… ${new Date().toLocaleString('pt-BR')}\x1b[0m`) },
        time: { desc: 'Hora atual', handler: () => terminalPrint(`\x1b[36mðŸ• ${new Date().toLocaleTimeString('pt-BR')}\x1b[0m`) },
        theme: { desc: 'Mudar tema [nome]', handler: (a) => { if (a[0] && typeof setTheme === 'function') { setTheme(a[0]); terminalPrint(`\x1b[32mâœ“ Tema: ${a[0]}\x1b[0m`); } else { terminalPrint('\x1b[33mTemas: cyberpunk, hacker, stealth, light, dracula, nord, monokai\x1b[0m'); } } },
        stop: { desc: 'Parar todos os ataques', handler: () => sendTerminalCommand('stop') },
        pwn: { desc: 'PWN EVERYTHING', handler: () => { terminalPrint('\x1b[31mðŸ’€ PWN EVERYTHING!\x1b[0m'); sendTerminalCommand('pwn_all'); } },
        cinema: { desc: 'Modo cinema', handler: () => { if (typeof toggleCinemaMode === 'function') toggleCinemaMode(); } },
        credits: { desc: 'CrÃ©ditos do projeto', handler: showCredits },
        ...
        grep: { desc: 'Buscar [padrÃ£o] [arquivo]', handler: (a) => sendTerminalCommand('grep', { pattern: a[0], file: a[1] }) },
        ...
        watch_vibrate: { desc: 'Vibrar relÃ³gio', handler: () => sendTerminalCommand('watch_vibrate') },
...
function showBanner() {
    terminalPrint('\x1b[35mâ•”â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•—\x1b[0m');
    terminalPrint('\x1b[35mâ•‘  â–ˆâ–ˆâ•—    â–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ•—â–ˆâ–ˆâ•—     â–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ•—â–ˆâ–ˆâ•—    â–ˆâ–ˆâ•— â–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ•— â–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ•— â–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ•—â–ˆâ–ˆâ•—  â–ˆâ–ˆâ•—  â•‘\x1b[0m');
    terminalPrint('\x1b[35mâ•‘  â–ˆâ–ˆâ•‘    â–ˆâ–ˆâ•”â•â•â•â•â•â–ˆâ–ˆâ•‘     â–ˆâ–ˆâ•”â•â•â•â•â•â–ˆâ–ˆâ•‘    â–ˆâ–ˆâ•‘â–ˆâ–ˆâ•”â•â•â–ˆâ–ˆâ•—â•šâ•â•â–ˆâ–ˆâ•”â•â•â•â–ˆâ–ˆâ•”â•â•â•â•â•â–ˆâ–ˆâ•‘  â–ˆâ–ˆâ•‘  â•‘\x1b[0m');
    terminalPrint('\x1b[35mâ•‘  â–ˆâ–ˆâ•‘    â–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ•—  â–ˆâ–ˆâ•‘     â–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ•—  â–ˆâ–ˆâ•‘ â–ˆâ•— â–ˆâ–ˆâ•‘â–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ•‘   â–ˆâ–ˆâ•‘   â–ˆâ–ˆâ•‘     â–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ•‘  â•‘\x1b[0m');
    terminalPrint('\x1b[35mâ•‘  â–ˆâ–ˆâ•‘    â–ˆâ–ˆâ•”â•â•â•  â–ˆâ–ˆâ•‘     â–ˆâ–ˆâ•”â•â•â•  â–ˆâ–ˆâ•‘â–ˆâ–ˆâ–ˆâ•—â–ˆâ–ˆâ•‘â–ˆâ–ˆâ•”â•â•â–ˆâ–ˆâ•‘   â–ˆâ–ˆâ•‘   â–ˆâ–ˆâ•‘     â–ˆâ–ˆâ•”â•â•â–ˆâ–ˆâ•‘  â•‘\x1b[0m');
    terminalPrint('\x1b[35mâ•‘  â–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ•—â–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ•—â–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ•—â–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ•—â•šâ–ˆâ–ˆâ–ˆâ•”â–ˆâ–ˆâ–ˆâ•”â•â–ˆâ–ˆâ•‘  â–ˆâ–ˆâ•‘   â–ˆâ–ˆâ•‘   â•šâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ•—â–ˆâ–ˆâ•‘  â–ˆâ–ˆâ•‘  â•‘\x1b[0m');
    terminalPrint('\x1b[35mâ•‘  â•šâ•â•â•â•â•â•â•â•šâ•â•â•â•â•â•â•â•šâ•â•â•â•â•â•â•â•šâ•â•â•â•â•â•â• â•šâ•â•â•â•šâ•â•â• â•šâ•â•  â•šâ•â•   â•šâ•â•    â•šâ•â•â•â•â•â•â•šâ•â•  â•šâ•â•  â•‘\x1b[0m');
    terminalPrint('\x1b[35mâ•šâ•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•\x1b[0m');
}
...
function showFortune() {
    const fortunes = [
        'ðŸ”® Grande poder vem com grande responsabilidade.',
        'ðŸ”® O prÃ³ximo handshake serÃ¡ o mais valioso.',
        'ðŸ”® Cuidado com redes abertas...',
        'ðŸ”® A paciÃªncia Ã© a chave do hacker.',
        'ðŸ”® Seu prÃ³ximo alvo estÃ¡ mais perto do que imagina.',
        'ðŸ”® NÃ£o existe sistema inviolÃ¡vel. SÃ³ falta tentativa.',
        'ðŸ”® O dragÃ£o sorri para vocÃª.',
        'ðŸ”® WPA3 nÃ£o Ã© pÃ¡reo para vocÃª.',
        'ðŸ”® Os bits estÃ£o ao seu favor hoje.'
    ];
...
function showAsciiArt(name) {
    if (name === 'dragon' || !name) {
        ...
        terminalPrint('\x1b[33mArte nÃ£o encontrada. Tente: dragon, skull\x1b[0m');
    }
}
...
function simulateHacking() {
    const lines = [
        ...
        '\x1b[32m[*] Escalando privilÃ©gios...\x1b[0m',
        '\x1b[32m[+] ROOT ACCESS OBTAINED!\x1b[0m',
        '\x1b[31mðŸ’€ SISTEMA COMPROMETIDO ðŸ’€\x1b[0m'
    ];
    let i = 0;
...
function showNeofetch() {
    ...
    terminalPrint('\x1b[36m      /     \\     \x1b[0m  â”€â”€â”€â”€â”€â”€â”€â”€â”€');
    terminalPrint('\x1b[36m     | () () |    \x1b[0m  \x1b[36mOS:\x1b[0m FreeRTOS');
    terminalPrint('\x1b[36m      \\  â–½  /     \x1b[0m  \x1b[36mHost:\x1b[0m ESP32-S3');
...
function showHistory() {
    if (terminalHistory.length === 0) {
        terminalPrint('\x1b[33mHistÃ³rico vazio\x1b[0m');
        return;
    }
    terminalPrint('\x1b[36mðŸ“œ HistÃ³rico de Comandos:\x1b[0m');
...
function showAliases() {
    terminalPrint('\x1b[36mðŸ”— Aliases:\x1b[0m');
    terminalPrint('  cls â†’ clear');
    terminalPrint('  q â†’ exit');
    terminalPrint('  scan â†’ wifi_scan');
    terminalPrint('  nuke â†’ ir_nuke');
}

function showEnv() {
    terminalPrint('\x1b[36mðŸŒ Environment:\x1b[0m');
...
function showCredits() {
    terminalPrint('\x1b[35mâ•”â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•—\x1b[0m');
    terminalPrint('\x1b[35mâ•‘       Lele CREDITS         â•‘\x1b[0m');
    terminalPrint('\x1b[35mâ• â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•£\x1b[0m');
    terminalPrint('\x1b[35mâ•‘  Developer: Lele              â•‘\x1b[0m');
    terminalPrint('\x1b[35mâ•‘  AI Assistant: Antigravity     â•‘\x1b[0m');
    terminalPrint('\x1b[35mâ•‘  Mascots: Neura, Lele, Lisa    â•‘\x1b[0m');
    terminalPrint('\x1b[35mâ•šâ•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•\x1b[0m');
}

function showAbout() {
    terminalPrint('\x1b[36mðŸ‰ Lele v2.0 - Cyberpunk Edition\x1b[0m');
    terminalPrint('');
    terminalPrint('Dispositivo multifunÃ§Ã£o para anÃ¡lise de seguranÃ§a');
    terminalPrint('WiFi â€¢ BLE â€¢ IR â€¢ CÃ¢meras â€¢ AI');
    terminalPrint('');
...
function showMan(cmd) {
    ...
    if (COMMANDS[cmd]) {
        ...
        terminalPrint(`\x1b[31mComando nÃ£o encontrado: ${cmd}\x1b[0m`);
    }
}
...
function showWelcome() {
    ...
    if (!output) return;
    output.innerHTML = `
<div style="color:#00fff5">â•”â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•—</div>
<div style="color:#ff00ff">â•‘  â–ˆâ–ˆâ•—    â–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ•—â–ˆâ–ˆâ•—     â–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ•—â–ˆâ–ˆâ•—    â–ˆâ–ˆâ•— â–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ•— â–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ•— â–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ•—â–ˆâ–ˆâ•—  â–ˆâ–ˆâ•—</div>
<div style="color:#ff00ff">â•‘  â–ˆâ–ˆâ•‘    â–ˆâ–ˆâ•”â•â•â•â•â•â–ˆâ–ˆâ•‘     â–ˆâ–ˆâ•”â•â•â•â•â•â–ˆâ–ˆâ•‘    â–ˆâ–ˆâ•‘â–ˆâ–ˆâ•”â•â•â–ˆâ–ˆâ•—â•šâ•â•â–ˆâ–ˆâ•”â•â•â•â–ˆâ–ˆâ•”â•â•â•â•â•â–ˆâ–ˆâ•‘  â–ˆâ–ˆâ•‘</div>
<div style="color:#ff00ff">â•‘  â–ˆâ–ˆâ•‘    â–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ•—  â–ˆâ–ˆâ•‘     â–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ•—  â–ˆâ–ˆâ•‘ â–ˆâ•— â–ˆâ–ˆâ•‘â–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ•‘   â–ˆâ–ˆâ•‘   â–ˆâ–ˆâ•‘     â–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ•‘</div>
<div style="color:#ff00ff">â•‘  â–ˆâ–ˆâ•‘    â–ˆâ–ˆâ•”â•â•â•  â–ˆâ–ˆâ•‘     â–ˆâ–ˆâ•”â•â•â•  â–ˆâ–ˆâ•‘â–ˆâ–ˆâ–ˆâ•—â–ˆâ–ˆâ•‘â–ˆâ–ˆâ•”â•â•â–ˆâ–ˆâ•‘   â–ˆâ–ˆâ•‘   â–ˆâ–ˆâ•‘     â–ˆâ–ˆâ•”â•â•â–ˆâ–ˆâ•‘</div>
<div style="color:#ff00ff">â•‘  â–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ•—â–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ•—â–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ•—â–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ•—â•šâ–ˆâ–ˆâ–ˆâ•”â–ˆâ–ˆâ–ˆâ•”â•â–ˆâ–ˆâ•‘  â–ˆâ–ˆâ•‘   â–ˆâ–ˆâ•‘   â•šâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ•—â–ˆâ–ˆâ•‘  â–ˆâ–ˆâ•‘</div>
<div style="color:#ff00ff">â•‘  â•šâ•â•â•â•â•â•â•â•šâ•â•â•â•â•â•â•â•šâ•â•â•â•â•â•â•â•šâ•â•â•â•â•â•â• â•šâ•â•â•â•šâ•â•â• â•šâ•â•  â•šâ•â•   â•šâ•â•    â•šâ•â•â•â•â•â•â•šâ•â•  â•šâ•â•</div>
<div style="color:#00fff5">â•šâ•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•</div>
<div></div>
<div style="color:#ffcc00">  ðŸ‰ Lele Terminal v2.0 - ${Object.keys(COMMANDS).length} comandos disponÃ­veis</div>
...
function showHelp() {
    terminalPrint('');
    terminalPrint(`<span style="color:#00fff5;font-weight:bold">ðŸ“‹ COMANDOS DISPONÃVEIS (${Object.keys(COMMANDS).length} total)</span>`);
    terminalPrint('<span style="color:#00fff5">â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•</span>');

    Object.entries(COMMAND_CATEGORIES).forEach(([category, cmds]) => {
        terminalPrint('');
        terminalPrint(`<span style="color:#ff00ff;font-weight:bold">â–¸ ${category.toUpperCase()}</span>`);
    ...
    terminalPrint('');
    terminalPrint('<span style="color:#ffcc00">ðŸ’¡ Use TAB para auto-completar, â†‘â†“ para histÃ³rico</span>');
}
