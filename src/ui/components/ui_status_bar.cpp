...
UIStatusBar::UIStatusBar()
    : _container(nullptr), _batteryLabel(nullptr), _wifiLabel(nullptr),
      _bleLabel(nullptr), _timeLabel(nullptr), _statusLabel(nullptr),
      _batteryPercent(100), _charging(false), _wifiConnected(false), _bleActive(false) {
}
...
void UIStatusBar::create(lv_obj_t* parent) {
    ...
    lv_obj_set_flex_align(_container, LV_FLEX_ALIGN_SPACE_BETWEEN, LV_FLEX_ALIGN_CENTER, LV_FLEX_ALIGN_CENTER);
...
void UIStatusBar::setStatus(const char* text) {
...
UINavBar::UINavBar()
    : _container(nullptr), _prevBtn(nullptr), _selectBtn(nullptr), _nextBtn(nullptr),
      _prevLabel(nullptr), _selectLabel(nullptr), _nextLabel(nullptr),
      _onPrev(nullptr), _onSelect(nullptr), _onNext(nullptr) {
}
