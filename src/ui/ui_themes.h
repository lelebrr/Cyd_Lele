...
// Using CUSTOM fonts with Latin Extended support (PT-BR)
// Titles: Bold 20 (Max available custom size)
#define FONT_TITLE &lv_font_montserrat_pt_20
// Large Numbers: Keep standard 48 (Digits don't need accents)
#define FONT_LARGE_NUM &lv_font_montserrat_48
// Secondary Text: Medium 20
#define FONT_TEXT_SEC &lv_font_montserrat_pt_m_20
// Small Text: Medium 14 (Smallest available custom is 14)
#define FONT_SMALL &lv_font_montserrat_pt_m_14
// Icons: Standard Montserrat (Symbols don't need accents)
