...
void rf_433_jammer() {
    ...
    ELECHOUSE_cc1101.setCarrierFreq(CFREQ_433);
    ...
    ELECHOUSE_cc1101.setPktFormat(PKT_FORMAT_0);
    ELECHOUSE_cc1101.setLengthConfig(LEN_CONFIG_0);
    ELECHOUSE_cc1101.setCRC(0); // No CRC, just noise
